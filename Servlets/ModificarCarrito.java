...
public class ModificarCarrito extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(sesion.getAttribute("id") != null && sesion.getAttribute("lista") != null ){
                if(request.getParameter("id") != null &&  request.getParameter("cantidad") != null){
                    ...
                    if(r == true && r2 == true){
                        MProducto p = AccionesProducto.buscarProducto(Integer.parseInt(request.getParameter("id")));
                        ...
                        Double descuento = (p.getDes_descuento() / 100) * total;
